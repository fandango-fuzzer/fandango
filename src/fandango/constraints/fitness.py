...
class BoundsFailingTree(FailingTree):
    ...
    def __init__(
        ...
        starting_rep: DerivationTree,
        ending_rep: DerivationTree,
        cause: "GeneticBase",
        suggestions: Optional[list[tuple[Comparison, Any, ComparisonSide]]] = None,
    ):
        """
        ...
        :param DerivationTree starting_rep: The reference to the subtree giving min repetition value
        :param DerivationTree ending_rep: A reference to the subtree giving max repetition value
        :param GeneticBase cause: The cause of the failure.
        :param Optional[list[tuple[Comparison, Any, ComparisonSide]]] suggestions: The list of suggestions to
        which causes the cause to fail.
        """
        ...
        self.ending_rep = ending_rep

    def __repr__(self):
        return f"BoundsFailingTree({self.tree}, {self.cause}, {str(self.starting_rep)}, {self.ending_rep}, {self.suggestions})"
