...
class DerivationTree:
    ...
    def deepcopy(self, *, copy_children=True, copy_params=True, copy_parent=True):
        return self.__deepcopy__(None, copy_children=copy_children, copy_params=copy_params, copy_parent=copy_parent)
    ...
    def replace_multiple(
        ...
        if self in replacements and not self.read_only:
            new_subtree = replacements[self].deepcopy(copy_children=True, copy_params=False, copy_parent=False)
