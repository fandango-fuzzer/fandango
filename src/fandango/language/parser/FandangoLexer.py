...
class FandangoLexer(FandangoLexerBase):
    ...
    def action(self, localctx: RuleContext, ruleIndex: int, actionIndex: int):
        if self._actions is None:
            ...
            actions[62] = self.OPEN_PAREN_action
            actions[63] = self.CLOSE_PAREN_action
            actions[69] = self.OPEN_BRACK_action
            actions[70] = self.CLOSE_BRACK_action
            actions[82] = self.OPEN_BRACE_action
            actions[83] = self.CLOSE_BRACE_action
            actions[108] = self.NEWLINE_action
