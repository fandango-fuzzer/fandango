...
class FandangoLexer(FandangoLexerBase):
    ...
    FSTRING_DOUBLE_QUOTE = 7
    FSTRING_DOUBLE_SINGLE_QUOTE = 8
    STRING = 9
    NUMBER = 10
    INTEGER = 11
    PYTHON_START = 12
    ...
    NAME = 60
    STRING_LITERAL = 61
    FSTRING_END_TRIPLE_QUOTE = 62
    FSTRING_END_TRIPLE_SINGLE_QUOTE = 63
    FSTRING_END_QUOTE = 64
    FSTRING_END_SINGLE_QUOTE = 65
    BYTES_LITERAL = 66
    DECIMAL_INTEGER = 67
    OCT_INTEGER = 68
    HEX_INTEGER = 69
    ...
    def action(self, localctx: RuleContext, ruleIndex: int, actionIndex: int):
        if self._actions is None:
            actions = dict()
            actions[9] = self.PYTHON_START_action
            actions[10] = self.PYTHON_END_action
            actions[17] = self.CASE_action
            actions[18] = self.CLASS_action
            actions[20] = self.DEF_action
            actions[22] = self.ELIF_action
            actions[23] = self.ELSE_action
            actions[24] = self.EXCEPT_action
            actions[26] = self.FINALLY_action
            actions[27] = self.FOR_action
            actions[30] = self.IF_action
            actions[35] = self.MATCH_action
            actions[44] = self.TRY_action
            actions[46] = self.WHILE_action
            actions[48] = self.WITH_action
            actions[77] = self.OPEN_PAREN_action
            actions[78] = self.CLOSE_PAREN_action
            actions[84] = self.OPEN_BRACK_action
            actions[85] = self.CLOSE_BRACK_action
            actions[97] = self.OPEN_BRACE_action
            actions[98] = self.CLOSE_BRACE_action
