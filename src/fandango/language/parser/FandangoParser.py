...
class FandangoParser(Parser):
    ...
    def program(self):
        ...
        try:
            ...
            while (((_la) & ~0x3F) == 0 and ((1 << _la) & 4494733192182808) != 0) or (
                (((_la - 65)) & ~0x3F) == 0
                and ((1 << (_la - 65)) & 4785076774832647) != 0
            ):
                self.state = 461
                self.statement()
                self.state = 465
    ...
    def python(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [11, 15, 17, 24, 27, 32, 41, 44, 46, 96]:
                self.enterOuterAlt(localctx, 1)
                self.state = 828
                self.compound_stmt()
                pass
    ...
    def python_file(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3F) == 0 and ((1 << _la) & 2489223983119384) != 0) or (
                (((_la - 65)) & ~0x3F) == 0
                and ((1 << (_la - 65)) & 4785076774832647) != 0
            ):
                self.state = 845
    ...
    def func_type(self):
        ...
        try:
            ...
            if (((_la) & ~0x3F) == 0 and ((1 << _la) & 2252944426668056) != 0) or (
                (((_la - 65)) & ~0x3F) == 0
                and ((1 << (_la - 65)) & 4503599650638471) != 0
            ):
                self.state = 864
    ...
    def statements(self):
        ...
        try:
            ...
            while True:
                ...
                _la = self._input.LA(1)
                if not (
                    (((_la) & ~0x3F) == 0 and ((1 << _la) & 2489223983119384) != 0)
                    or (
                        (((_la - 65)) & ~0x3F) == 0
                        and ((1 << (_la - 65)) & 4785076774832647) != 0
                    )
    ...
    def subject_expr(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                if (((_la) & ~0x3F) == 0 and ((1 << _la) & 2252944426668056) != 0) or (
                    (((_la - 65)) & ~0x3F) == 0
                    and ((1 << (_la - 65)) & 4503599650638343) != 0
                ):
                    self.state = 1546
    ...
    def sequence_pattern(self):
        ...
        try:
            ...
            if token in [74]:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3F) == 0 and ((1 << _la) & 2261704012464152) != 0) or (
                    (((_la - 66)) & ~0x3F) == 0
    ...
    def maybe_star_pattern(self):
        ...
        try:
            ...
            if token in [66]:
                ...
                self.star_pattern()
                pass
            elif token in [3, 4, 22, 33, 40, 43, 51, 67, 74, 82, 87, 117]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1689
                self.pattern()
                pass
    ...
    def key_value_pattern(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [3, 4, 22, 33, 40, 82, 117]:
                self.state = 1733
                self.literal_expr()
                pass
            elif token in [51]:
    ...
    def factor(self):
        ...
        try:
            ...
            if token in [81]:
                ...
                self.factor()
                pass
            elif token in [3, 4, 12, 22, 33, 40, 51, 65, 67, 74, 76, 87, 89, 117]:
                self.enterOuterAlt(localctx, 4)
                self.state = 2063
                self.power()
                pass
    ...
    def await_primary(self):
        ...
        try:
            ...
            if token in [12]:
                ...
                self.primary(0)
                pass
            elif token in [3, 4, 22, 33, 40, 51, 65, 67, 74, 76, 87, 89, 117]:
                self.enterOuterAlt(localctx, 2)
                self.state = 2075
                self.primary(0)
                pass
    ...
    def slice_(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                if (((_la) & ~0x3F) == 0 and ((1 << _la) & 2252944426668056) != 0) or (
                    (((_la - 65)) & ~0x3F) == 0
                    and ((1 << (_la - 65)) & 4503599650638341) != 0
                ):
                    self.state = 2119
                    self.expression()
    ...
    def dict_(self):
        ...
        try:
            ...
            if (((_la) & ~0x3F) == 0 and ((1 << _la) & 2252944426668056) != 0) or (
                (((_la - 65)) & ~0x3F) == 0
                and ((1 << (_la - 65)) & 4503599650638469) != 0
            ):
                self.state = 2369
        ...
        try:
            ...
            if la_ == 1:
                ...
                if (((_la) & ~0x3F) == 0 and ((1 << _la) & 2252907919441944) != 0) or (
                    (((_la - 65)) & ~0x3F) == 0
                    and ((1 << (_la - 65)) & 4503599648344583) != 0
                ):
                    self.state = 2571
    ...
    def del_t_atom(self):
        ...
        try:
            ...
            if token in [51]:
                ...
                if (((_la) & ~0x3F) == 0 and ((1 << _la) & 2252907919441944) != 0) or (
                    (((_la - 65)) & ~0x3F) == 0
                    and ((1 << (_la - 65)) & 4503599648344581) != 0
                ):
                    self.state = 2650
                    self.del_targets()
