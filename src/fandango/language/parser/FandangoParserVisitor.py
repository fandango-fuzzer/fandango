...
class FandangoParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by FandangoParser#parallel.
    ...
    def visitStar_selection_or_dot_selection(self, ctx:FandangoParser.Star_selection_or_dot_selectionContext):
        return self.visitChildren(ctx)
    ...
    def visitGrammar_setting_content(self, ctx:FandangoParser.Grammar_setting_contentContext):
        return self.visitChildren(ctx)
    ...
    def visitGrammar_setting_value(self, ctx:FandangoParser.Grammar_setting_valueContext):
        return self.visitChildren(ctx)
    ...
    def visitImport_from_as_names(self, ctx:FandangoParser.Import_from_as_namesContext):
        return self.visitChildren(ctx)
    ...
    def visitParam_no_default_star_annotation(self, ctx:FandangoParser.Param_no_default_star_annotationContext):
        return self.visitChildren(ctx)
    ...
    def visitParam_star_annotation(self, ctx:FandangoParser.Param_star_annotationContext):
        return self.visitChildren(ctx)
    ...
    def visitPattern_capture_target(self, ctx:FandangoParser.Pattern_capture_targetContext):
        return self.visitChildren(ctx)
    ...
    def visitOpen_sequence_pattern(self, ctx:FandangoParser.Open_sequence_patternContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#maybe_sequence_pattern.
    def visitMaybe_sequence_pattern(self, ctx:FandangoParser.Maybe_sequence_patternContext):
        return self.visitChildren(ctx)
    ...
    def visitStar_named_expressions(self, ctx:FandangoParser.Star_named_expressionsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#star_named_expression.
    def visitStar_named_expression(self, ctx:FandangoParser.Star_named_expressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#assignment_expression.
    def visitAssignment_expression(self, ctx:FandangoParser.Assignment_expressionContext):
        return self.visitChildren(ctx)
    ...
    def visitCompare_op_bitwise_or_pair(self, ctx:FandangoParser.Compare_op_bitwise_or_pairContext):
        return self.visitChildren(ctx)
    ...
    def visitLambda_slash_no_default(self, ctx:FandangoParser.Lambda_slash_no_defaultContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#lambda_slash_with_default.
    def visitLambda_slash_with_default(self, ctx:FandangoParser.Lambda_slash_with_defaultContext):
        return self.visitChildren(ctx)
    ...
    def visitLambda_param_no_default(self, ctx:FandangoParser.Lambda_param_no_defaultContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#lambda_param_with_default.
    def visitLambda_param_with_default(self, ctx:FandangoParser.Lambda_param_with_defaultContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#lambda_param_maybe_default.
    def visitLambda_param_maybe_default(self, ctx:FandangoParser.Lambda_param_maybe_defaultContext):
        return self.visitChildren(ctx)
    ...
    def visitFstring_middle_no_quote(self, ctx:FandangoParser.Fstring_middle_no_quoteContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#fstring_middle_no_single_quote.
    def visitFstring_middle_no_single_quote(self, ctx:FandangoParser.Fstring_middle_no_single_quoteContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#fstring_middle_breaks_no_triple_quote.
    def visitFstring_middle_breaks_no_triple_quote(self, ctx:FandangoParser.Fstring_middle_breaks_no_triple_quoteContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#fstring_middle_breaks_no_triple_single_quote.
    def visitFstring_middle_breaks_no_triple_single_quote(self, ctx:FandangoParser.Fstring_middle_breaks_no_triple_single_quoteContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#fstring_any_no_quote.
    def visitFstring_any_no_quote(self, ctx:FandangoParser.Fstring_any_no_quoteContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#fstring_any_no_single_quote.
    def visitFstring_any_no_single_quote(self, ctx:FandangoParser.Fstring_any_no_single_quoteContext):
        return self.visitChildren(ctx)
    ...
    def visitFstring_any_breaks_no_triple_quote(self, ctx:FandangoParser.Fstring_any_breaks_no_triple_quoteContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#fstring_any_breaks_no_triple_single_quote.
    def visitFstring_any_breaks_no_triple_single_quote(self, ctx:FandangoParser.Fstring_any_breaks_no_triple_single_quoteContext):
        return self.visitChildren(ctx)
    ...
    def visitFstring_replacement_field(self, ctx:FandangoParser.Fstring_replacement_fieldContext):
        return self.visitChildren(ctx)
    ...
    def visitFstring_full_format_spec(self, ctx:FandangoParser.Fstring_full_format_specContext):
        return self.visitChildren(ctx)
    ...
    def visitDouble_starred_kvpairs(self, ctx:FandangoParser.Double_starred_kvpairsContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#double_starred_kvpair.
    def visitDouble_starred_kvpair(self, ctx:FandangoParser.Double_starred_kvpairContext):
        return self.visitChildren(ctx)
    ...
    def visitKwarg_or_double_starred(self, ctx:FandangoParser.Kwarg_or_double_starredContext):
        return self.visitChildren(ctx)
    ...
    def visitStar_targets_list_seq(self, ctx:FandangoParser.Star_targets_list_seqContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FandangoParser#star_targets_tuple_seq.
    def visitStar_targets_tuple_seq(self, ctx:FandangoParser.Star_targets_tuple_seqContext):
        return self.visitChildren(ctx)
    ...
    def visitTarget_with_star_atom(self, ctx:FandangoParser.Target_with_star_atomContext):
        return self.visitChildren(ctx)
    ...
    def visitSingle_subscript_attribute_target(self, ctx:FandangoParser.Single_subscript_attribute_targetContext):
        return self.visitChildren(ctx)
