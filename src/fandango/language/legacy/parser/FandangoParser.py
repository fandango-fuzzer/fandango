...
class FandangoParser(Parser):
    ...
    RULE_star_selection_or_dot_selection = 22
    RULE_star_selection = 23
    RULE_dot_selection = 24
    RULE_selection = 25
    ...
    OR_ASSIGN = 109
    XOR_ASSIGN = 110
    LEFT_SHIFT_ASSIGN = 111
    RIGHT_SHIFT_ASSIGN = 112
    POWER_ASSIGN = 113
    IDIV_ASSIGN = 114
    EXPR_ASSIGN = 115
    EXCL = 116
    ...
    def program(self):
        ...
        try:
            ...
            while (((_la) & ~0x3F) == 0 and ((1 << _la) & 72039861167552792) != 0) or (
                (((_la - 69)) & ~0x3F) == 0
                and ((1 << (_la - 69)) & 4785076758055559) != 0
            ):
                self.state = 463
                self.statement()
                self.state = 467
    ...
    def production(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.state = 487
                _la = self._input.LA(1)
                if not (_la == -1 or _la == 75 or _la == 117):
    ...
    def repeat(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3F) == 0 and ((1 << _la) & 67556283636523288) != 0) or (
                    (((_la - 69)) & ~0x3F) == 0
                    and ((1 << (_la - 69)) & 4503599633861255) != 0
                ):
                    self.state = 548
                    self.expression()
    ...
    class Star_selection_or_dot_selectionContext(ParserRuleContext):
        ...
        def enterRule(self, listener: ParseTreeListener):
            if hasattr(listener, "enterStar_selection_or_dot_selection"):
                listener.enterStar_selection_or_dot_selection(self)

        def exitRule(self, listener: ParseTreeListener):
            if hasattr(listener, "exitStar_selection_or_dot_selection"):
                listener.exitStar_selection_or_dot_selection(self)
    ...
    def star_selection_or_dot_selection(self):
        ...
        self.enterRule(localctx, 44, self.RULE_star_selection_or_dot_selection)
        try:
            self.state = 760
            self._errHandler.sync(self)
            token = self._input.LA(1)
    ...
    class Star_selectionContext(ParserRuleContext):
        ...
        def enterRule(self, listener: ParseTreeListener):
            if hasattr(listener, "enterStar_selection"):
                listener.enterStar_selection(self)

        def exitRule(self, listener: ParseTreeListener):
            if hasattr(listener, "exitStar_selection"):
                listener.exitStar_selection(self)
    ...
    def star_selection(self):
        ...
        self.enterRule(localctx, 46, self.RULE_star_selection)
        try:
            self.state = 766
            self._errHandler.sync(self)
            token = self._input.LA(1)
    ...
    class Dot_selectionContext(ParserRuleContext):
        ...
        def enterRule(self, listener: ParseTreeListener):
            if hasattr(listener, "enterDot_selection"):
                listener.enterDot_selection(self)

        def exitRule(self, listener: ParseTreeListener):
            if hasattr(listener, "exitDot_selection"):
                listener.exitDot_selection(self)
    ...
    def dot_selection(self, _p: int = 0):
        ...
        _prevctx = localctx
        _startState = 48
        self.enterRecursionRule(localctx, 48, self.RULE_dot_selection, _p)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 769
            self.selection()
    ...
    def python(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [12, 16, 18, 25, 28, 33, 42, 45, 47, 100]:
                self.enterOuterAlt(localctx, 1)
                self.state = 851
                self.compound_stmt()
                pass
    ...
    def python_file(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3F) == 0 and ((1 << _la) & 68028842749425944) != 0) or (
                (((_la - 69)) & ~0x3F) == 0
                and ((1 << (_la - 69)) & 4785076758055559) != 0
            ):
                self.state = 868
    ...
    def statements(self):
        ...
        try:
            ...
            while True:
                ...
                _la = self._input.LA(1)
                if not (
                    (((_la) & ~0x3F) == 0 and ((1 << _la) & 68028842749425944) != 0)
                    or (
                        (((_la - 69)) & ~0x3F) == 0
                        and ((1 << (_la - 69)) & 4785076758055559) != 0
                    )
    ...
    def augassign(self):
        ...
        try:
            ...
            _la = self._input.LA(1)
            if not (
                ((((_la - 102)) & ~0x3F) == 0 and ((1 << (_la - 102)) & 8191) != 0)
            ):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
    ...
    def function_def_raw(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la - 52)) & ~0x3F) == 0 and ((1 << (_la - 52)) & 17039375) != 0:
                self.state = 1183
                self.params()
        ...
        try:
            ...
            if la_ == 1:
                ...
                while True:
                    ...
                    _la = self._input.LA(1)
                    if not (
                        (((_la) & ~0x3F) == 0 and ((1 << _la) & 67553994410557440) != 0)
                    ):
                        break
    ...
    def sequence_pattern(self):
        ...
        try:
            ...
            if token in [78]:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3F) == 0 and ((1 << _la) & 67573802808115224) != 0) or (
                    (((_la - 70)) & ~0x3F) == 0
                    and ((1 << (_la - 70)) & 2251799815848195) != 0
                ):
                    self.state = 1684
    ...
    def maybe_star_pattern(self):
        ...
        try:
            ...
            if token in [70]:
                ...
                self.star_pattern()
                pass
            elif token in [3, 4, 23, 34, 41, 44, 52, 53, 54, 55, 71, 78, 86, 91, 121]:
                self.enterOuterAlt(localctx, 2)
                self.state = 1712
                self.pattern()
                pass
    ...
    def key_value_pattern(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [3, 4, 23, 34, 41, 86, 121]:
                self.state = 1756
                self.literal_expr()
                pass
            elif token in [52, 53, 54, 55]:
        ...
        try:
            ...
            if la_ == 1:
                ...
                if _la == 74:
                    ...
                    _la = self._input.LA(1)
                    if (
                        ((_la) & ~0x3F) == 0 and ((1 << _la) & 67556283636523288) != 0
                    ) or (
                        (((_la - 69)) & ~0x3F) == 0
                        and ((1 << (_la - 69)) & 4503599633861255) != 0
                    ):
    ...
    def star_atom(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if (((_la) & ~0x3F) == 0 and ((1 << _la) & 67556210622071064) != 0) or (
                    (((_la - 69)) & ~0x3F) == 0
                    and ((1 << (_la - 69)) & 4503599631567495) != 0
                ):
                    self.state = 2596
    ...
    def identifier(self):
        ...
        self.enterRule(localctx, 452, self.RULE_identifier)
        self._la = 0  # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 2747
    ...
    def sempred(self, localctx: RuleContext, ruleIndex: int, predIndex: int):
        ...
        self._predicates[24] = self.dot_selection_sempred
