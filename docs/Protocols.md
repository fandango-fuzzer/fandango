...
```shell
$ python -m aiosmtpd -d -n -l 127.0.0.1:8025 &
```
...
aiosmtpd_proc = subprocess.Popen(
...
We give it a hostname (`127.0.0.1` for our local machine) and a port (8025 for our local SMTP server.)
