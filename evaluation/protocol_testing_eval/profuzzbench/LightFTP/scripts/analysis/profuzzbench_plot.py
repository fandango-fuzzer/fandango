...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-i", "--csv_file", type=str, required=True, help="Full path to results.csv"
    )
    parser.add_argument(
        "-p", "--put", type=str, required=True, help="Name of the subject program"
    )
    parser.add_argument(
        "-r", "--runs", type=int, required=True, help="Number of runs in the experiment"
    )
    parser.add_argument(
        "-c", "--cut_off", type=int, required=True, help="Cut-off time in minutes"
    )
    parser.add_argument(
        "-s", "--step", type=int, required=True, help="Time step in minutes"
    )
